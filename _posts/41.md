...
<p class="text-center text-dark text-opacity-50 fst-italic">before</p>

![](/images/posts/ca865528692d-20220630.png)

<p class="text-center text-dark text-opacity-50 fst-italic">after(なぜか背景が黒くなる)</p>
...
<p class="text-center text-dark text-opacity-50 fst-italic">左：基点ブランチ 右：Renovateブランチ</p>
