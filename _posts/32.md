...
date: '2022-06-11T00:00:00.000+0900'
excerpt: 'マークダウンを校正しPDF形式のスライドに変換する方法を解説しました。Slidevの設定やtextlintを用いた校正手順、GitHub Actionsでの自動化について記載しました。'
tags: ['slidev', 'vue', 'vite', 'markdown', 'textlint', 'githubactions']
published: true
---
